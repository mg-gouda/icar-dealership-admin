...
export const ar: Record<string, string> = {
  ...
  'fin.commissionPlans': 'خطط العمولات',
...
export const en: Record<string, string> = {
  ...
  'fin.currencies': 'Currencies', 'fin.commissionPlans': 'Commission Plans',
  'fin.commissions': 'Commissions', 'fin.payments': 'Payments', 'fin.invoices': 'Invoices',
